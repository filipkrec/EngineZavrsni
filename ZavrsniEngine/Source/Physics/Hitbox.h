...
namespace physics {
	...
	class Hitbox {
		...
		graphics::Sprite const* _boundSprite;
	public:
		~Hitbox();
		Hitbox(graphics::Sprite const* sprite, Shape shape, float width, float height = 0);
		...
		inline graphics::Sprite const* getSprite() { return _boundSprite; }
