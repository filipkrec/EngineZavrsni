...
namespace objects {
		...
		public:
			...
			inline const bool isReloading() { return _reloadTimer.elapsed() <= _reloadTime; }
			inline const bool isShotCooldown() { return _shotCooldownTimer.elapsed() <= _shotCooldownTime; }
